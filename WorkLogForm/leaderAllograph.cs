...
{
    public partial class leaderAllograph : Form
    {
        public leaderAllograph()
        {
            InitializeComponent();
            initialWindow();
        }
        ...
        private void leaderAllograph_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void leaderAllograph_MouseMove(object sender, MouseEventArgs e)
        {
